...
public class ChildReportDetailActivity extends AppCompatActivity {
    private static final String SERVER_URL = "http://greyk.iptime.org:8000/app/report_detail_children";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_child_report_detail);

        reportContent = findViewById(R.id.report_child_content);
    ...
    private void fetchReportDetail() {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                runOnUiThread(() -> Toast.makeText(ChildReportDetailActivity.this, "서버 연결 실패", Toast.LENGTH_SHORT).show());
            }
